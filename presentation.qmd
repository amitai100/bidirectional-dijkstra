...
-   In particular, all of $t$'s incoming neighbors with smaller distance were explored
...
-   W.L.O.G, in the undirected case: $$d(s,u_{1}) \le d(s,v_{1}) \text{ and } d(v_{2},t) \le d(u_{2},t)$$
...
$$d(s,u_1) \le d(s,u_s)$$ $$d(v_2,t) \le d(u_t,t)$$
:::
...
-   The forward search explores at most $|\bar{B}_{x+1}(s)| + 1 \le 1 + |E_s| + 1 = O(|E_s|)$ vertices.
