...
- **Arbitrarily Small Weights:** The adversarial graph requires weights where $\delta' < \delta$. In unweighted graphs (minimum weight 1), only *approximate* instance optimality is achievable.
