## Bidirectional Dijkstra's Algorithm is Instance-Optimal {.center}
::: {.notes}
Welcome everyone. In this part of the presentation, I'll walk you through the first four sections of the paper: the Introduction, Related Work, Preliminaries, and the Warm-Up proof. We'll build up from the problem motivation all the way to a clean proof of instance-optimality in the directed setting.
:::
...
::: {.incremental}
- Dantzig (1963), Nicholson (1966), Pohl (1969) — early bidirectional proposals
